...
function createBoard(){
  for(i=0;i<16;i++){
    ...
    card.setAttribute('src','img/dragon-ball-Background.webp')
...
function checkMatch(){
  ...
  {
    cards[optionOne].setAttribute('src','img/dragon-ball-Background.webp')
    cards[optionTwo].setAttribute('src','img/dragon-ball-Background.webp')
  }
